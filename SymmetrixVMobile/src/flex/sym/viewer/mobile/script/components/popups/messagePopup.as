 ...
 */
public static function open(message:String, title:String, owner:DisplayObjectContainer, type:int = NORMAL_MESSAGE, buttons:uint = BUTTON_OK):MessagePopup
{
    var popup:MessagePopup = new MessagePopup();
